                    ...
                    <View style={styles.profileHeader}>
                        ...
                        <View style={styles.profileInfo}>
                            <Text style={styles.profileName}>
                                {profile?.name || (isAuthenticated ? 'Wallet Connected' : 'Disconnected')}
                            </Text>
                            <Text style={styles.profileType}>
  {profile?.userType || (isAuthenticated ? 'Wallet Connected' : 'Disconnected')}
</Text>
                            {isAuthenticated && (
                    ...
                    <View style={styles.profileDetails}>
                        ...
                        <Text style={styles.detailText}>{profile?.email || (isAuthenticated ? 'No email' : 'Disconnected')}</Text>
                        </View>
                        {isAuthenticated && (
                            <View style={styles.detailItem}>
                                <MapPin size={16} color="#6B7280" />
                                <Text style={styles.detailText}>{profile?.country || (isAuthenticated ? 'No country' : 'Disconnected')}</Text>
                            </View>
                        )}
                        {isAuthenticated && (
                            <View style={styles.detailItem}>
                                <Linkedin size={16} color="#6B7280" />
                                <Text style={styles.detailText}>{profile?.linkedin || (isAuthenticated ? 'No LinkedIn' : 'Disconnected')}</Text>
                            </View>
                        )}
                    </View>
                    ...
                    {isAuthenticated && (
                        <View style={styles.bioSection}>
                            ...
                            <Text style={styles.bioText}>{profile?.bio || (isAuthenticated ? 'No bio yet' : 'Disconnected')}</Text>
                        </View>
                    )}
